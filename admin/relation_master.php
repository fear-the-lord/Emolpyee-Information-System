...
<body>
    <form action="#">
        ...
        <div class="float-label">
          <input type="number" name="Relation_Id" id="email" />
          <label for="email">Relation Id</label>
        </div>
        
        <div class="float-label">
          <input type="text" name="Relation_Desc" id="f-name" />
          <label for="f-name">Relation Description</label>
        </div>
