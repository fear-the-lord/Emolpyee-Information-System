...
<body>
    <form action="#">
        ...
        <div class="float-label">
          <input type="number" name="Country_Id" id="email" />
          <label for="email">Country Id</label>
        </div>
        
        <div class="float-label">
          <input type="number" name="Country_Name" id="f-name" />
          <label for="f-name">Country Name</label>
        </div>
