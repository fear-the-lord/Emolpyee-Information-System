...
<body>
    <form action="#">
        ...
        <div class="float-label">
          <input type="number" name="Education_Id" id="email" />
          <label for="email">Education Id</label>
        </div>
        
        <div class="float-label">
          <input type="text" name="Education_Desc" id="f-name" />
          <label for="f-name">Education Description</label>
        </div>
